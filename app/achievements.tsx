...
import { ChevronLeft, Trophy, Medal, MapPin, Globe, Star, Swords, Fish, Heart, Scale as Whale } from 'lucide-react-native';
...
export default function AchievementsScreen() {
  ...
  const percentComplete = totalCount === 0 ? 0 : Math.floor((unlockedCount / totalCount) * 100);
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 50, paddingHorizontal: 20, paddingBottom: 15, backgroundColor: '#1E1E1E' },
  backButton: { padding: 5 },
  headerTitle: { fontSize: 20, fontWeight: 'bold', color: 'white' },
  placeholder: { width: 34 },
  content: { flex: 1, padding: 20 },
  statsContainer: { flexDirection: 'row', backgroundColor: '#1E1E1E', borderRadius: 15, padding: 20, marginBottom: 20 },
  statItem: { flex: 1, alignItems: 'center' },
  statValue: { fontSize: 24, fontWeight: 'bold', color: '#0077B6', marginBottom: 5 },
  statLabel: { fontSize: 14, color: '#AAAAAA' },
  statDivider: { width: 1, height: '80%', backgroundColor: '#333', marginHorizontal: 20 },
  errorContainer: { backgroundColor: 'rgba(198, 40, 40, 0.2)', padding: 15, borderRadius: 8, marginBottom: 20 },
  ...
  categoryTitle: { fontSize: 18, fontWeight: 'bold', color: 'white', marginLeft: 10 },
  achievementCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E1E1E', borderRadius: 12, padding: 15, marginBottom: 10 },
  achievementCardUnlocked: { backgroundColor: '#1E3A8A' },
  achievementIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#2A2A2A', justifyContent: 'center', alignItems: 'center', marginRight: 15 },
  achievementInfo: { flex: 1, marginRight: 10 },
  achievementName: { fontSize: 16, fontWeight: 'bold', color: '#AAAAAA', marginBottom: 4 },
  achievementNameUnlocked: { color: 'white' },
  achievementDescription: { fontSize: 14, color: '#777777', marginBottom: 4 },
  achievementDate: { fontSize: 12, color: '#0077B6', fontStyle: 'italic' },
});