...
with_node \
  ...
  --target "/Users/tariqbakkali/Documents/SeaVault/seavaultapp/ios/Pods/Target Support Files/Pods-SeaVault/ExpoModulesProvider.swift" \
  --entitlement "/Users/tariqbakkali/Documents/SeaVault/seavaultapp/ios/SeaVault/SeaVault.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-media-library" "expo-router" "expo-secure-store" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
